...
(() => {
  ...
  const FINAL_I18N = {
    de: {
      "AI POWERED • PRIVATE":"KI-BASIERT • PRIVAT",
      "Discover people nearby or expand your search around the world with an adjustable search radius. Your location is never shown to other users. AI uses it exclusively to find suitable partners near you.":"Entdecke Menschen in deiner Nähe oder erweitere deine Suche weltweit mit einem einstellbaren Suchradius. Dein Standort wird anderen Nutzern niemals angezeigt. Die KI verwendet ihn ausschließlich, um passende Partner in deiner Nähe zu finden.",
      "HOW IT WORKS IN REAL LIFE":"SO FUNKTIONIERT ES IM ALLTAG",
      "Nearby discovery with private intent matching":"Menschen in der Nähe finden – mit privatem Interessenabgleich",
      "For example: while relaxing at the beach, choose a 500 m search radius. HEARTLINK AI can privately compare your Secret Desire — such as “Open to continuing the evening together today” — and show compatible people nearby without revealing your exact location.":"Beispiel: Während du am Strand entspannst, wählst du einen Suchradius von 500 m. HEARTLINK AI kann deinen Secret Desire – etwa „Offen dafür, den heutigen Abend gemeinsam fortzusetzen“ – vertraulich abgleichen und passende Menschen in der Nähe anzeigen, ohne deinen genauen Standort offenzulegen.",
      "What does it cost to use HEARTLINK AI?":"Was kostet die Nutzung von HEARTLINK AI?",
      "Currently, HEARTLINK AI costs 1.5 USD for 10 hours of use. You can pause the bot whenever you do not plan to use it; while paused, the usage timer stops and your remaining paid time is preserved.":"Derzeit kostet HEARTLINK AI 1,5 USD für 10 Stunden Nutzung. Du kannst den Bot jederzeit pausieren, wenn du ihn gerade nicht nutzen möchtest. Während der Pause wird der Nutzungszähler angehalten und deine verbleibende bezahlte Zeit bleibt erhalten.",
      "If my paid time has ended, will my profile still appear in search?":"Wird mein Profil weiterhin in der Suche angezeigt, wenn meine bezahlte Zeit abgelaufen ist?",
      "No. Only active, paid profiles participate in search. If your profile is inactive, the system assumes that you are not currently planning to meet people. Once paid time is renewed, your profile becomes active and participates in search again.":"Nein. An der Suche nehmen nur aktive, bezahlte Profile teil. Ist dein Profil inaktiv, geht das System davon aus, dass du derzeit keine neuen Kontakte suchst. Nach der Verlängerung der bezahlten Zeit wird dein Profil wieder aktiv und nimmt erneut an der Suche teil.",
      "Will other users be able to see my location?":"Können andere Nutzer meinen Standort sehen?",
      "No. Your exact location is never shown to other users. HEARTLINK AI uses location data exclusively to find suitable people within the search radius you choose.":"Nein. Dein genauer Standort wird anderen Nutzern niemals angezeigt. HEARTLINK AI verwendet Standortdaten ausschließlich, um passende Menschen innerhalb des von dir gewählten Suchradius zu finden."
    },
    fr: {
      "AI POWERED • PRIVATE":"PROPULSÉ PAR IA • PRIVÉ",
      "Discover people nearby or expand your search around the world with an adjustable search radius. Your location is never shown to other users. AI uses it exclusively to find suitable partners near you.":"Découvrez des personnes à proximité ou élargissez votre recherche dans le monde entier grâce à un rayon réglable. Votre position n’est jamais affichée aux autres utilisateurs. L’IA l’utilise exclusivement pour trouver des partenaires compatibles près de vous.",
      "HOW IT WORKS IN REAL LIFE":"COMMENT ÇA MARCHE EN PRATIQUE",
      "Nearby discovery with private intent matching":"Découverte à proximité avec correspondance privée des intentions",
      "For example: while relaxing at the beach, choose a 500 m search radius. HEARTLINK AI can privately compare your Secret Desire — such as “Open to continuing the evening together today” — and show compatible people nearby without revealing your exact location.":"Par exemple, pendant que vous vous détendez à la plage, choisissez un rayon de recherche de 500 m. HEARTLINK AI peut comparer en privé votre Secret Desire — par exemple « Ouvert(e) à poursuivre la soirée ensemble aujourd’hui » — et afficher des personnes compatibles à proximité sans révéler votre position exacte.",
      "What does it cost to use HEARTLINK AI?":"Quel est le coût d’utilisation de HEARTLINK AI ?",
      "Currently, HEARTLINK AI costs 1.5 USD for 10 hours of use. You can pause the bot whenever you do not plan to use it; while paused, the usage timer stops and your remaining paid time is preserved.":"Actuellement, HEARTLINK AI coûte 1,5 USD pour 10 heures d’utilisation. Vous pouvez mettre le bot en pause lorsque vous ne prévoyez pas de l’utiliser ; pendant la pause, le compteur s’arrête et votre temps payé restant est conservé.",
      "If my paid time has ended, will my profile still appear in search?":"Si mon temps payé est terminé, mon profil apparaîtra-t-il encore dans la recherche ?",
      "No. Only active, paid profiles participate in search. If your profile is inactive, the system assumes that you are not currently planning to meet people. Once paid time is renewed, your profile becomes active and participates in search again.":"Non. Seuls les profils actifs et payés participent à la recherche. Si votre profil est inactif, le système considère que vous ne prévoyez pas actuellement de faire des rencontres. Après renouvellement du temps payé, votre profil redevient actif et participe de nouveau à la recherche.",
      "Will other users be able to see my location?":"Les autres utilisateurs pourront-ils voir ma position ?",
      "No. Your exact location is never shown to other users. HEARTLINK AI uses location data exclusively to find suitable people within the search radius you choose.":"Non. Votre position exacte n’est jamais affichée aux autres utilisateurs. HEARTLINK AI utilise les données de localisation exclusivement pour trouver des personnes compatibles dans le rayon de recherche que vous choisissez."
    },
    es: {
      "AI POWERED • PRIVATE":"IMPULSADO POR IA • PRIVADO",
      "Discover people nearby or expand your search around the world with an adjustable search radius. Your location is never shown to other users. AI uses it exclusively to find suitable partners near you.":"Descubre personas cercanas o amplía la búsqueda por todo el mundo con un radio ajustable. Tu ubicación nunca se muestra a otros usuarios. La IA la utiliza exclusivamente para encontrar personas compatibles cerca de ti.",
      "HOW IT WORKS IN REAL LIFE":"CÓMO FUNCIONA EN LA VIDA REAL",
      "Nearby discovery with private intent matching":"Descubrimiento cercano con coincidencia privada de intenciones",
      "For example: while relaxing at the beach, choose a 500 m search radius. HEARTLINK AI can privately compare your Secret Desire — such as “Open to continuing the evening together today” — and show compatible people nearby without revealing your exact location.":"Por ejemplo, mientras te relajas en la playa, elige un radio de búsqueda de 500 m. HEARTLINK AI puede comparar de forma privada tu Secret Desire — por ejemplo, «Dispuesto/a a continuar la velada juntos hoy» — y mostrar personas compatibles cercanas sin revelar tu ubicación exacta.",
      "What does it cost to use HEARTLINK AI?":"¿Cuánto cuesta usar HEARTLINK AI?",
      "Currently, HEARTLINK AI costs 1.5 USD for 10 hours of use. You can pause the bot whenever you do not plan to use it; while paused, the usage timer stops and your remaining paid time is preserved.":"Actualmente, HEARTLINK AI cuesta 1,5 USD por 10 horas de uso. Puedes pausar el bot cuando no tengas previsto utilizarlo; durante la pausa, el contador se detiene y se conserva el tiempo pagado restante.",
      "If my paid time has ended, will my profile still appear in search?":"Si se termina mi tiempo pagado, ¿mi perfil seguirá apareciendo en la búsqueda?",
      "No. Only active, paid profiles participate in search. If your profile is inactive, the system assumes that you are not currently planning to meet people. Once paid time is renewed, your profile becomes active and participates in search again.":"No. Solo los perfiles activos y pagados participan en la búsqueda. Si tu perfil está inactivo, el sistema entiende que en ese momento no planeas conocer gente. Al renovar el tiempo pagado, tu perfil vuelve a estar activo y participa de nuevo en la búsqueda.",
      "Will other users be able to see my location?":"¿Podrán otros usuarios ver mi ubicación?",
      "No. Your exact location is never shown to other users. HEARTLINK AI uses location data exclusively to find suitable people within the search radius you choose.":"No. Tu ubicación exacta nunca se muestra a otros usuarios. HEARTLINK AI utiliza los datos de ubicación exclusivamente para encontrar personas compatibles dentro del radio de búsqueda que elijas."
    }
  };
  Object.keys(FINAL_I18N).forEach(lang => Object.assign(I18N[lang] || (I18N[lang] = {}), FINAL_I18N[lang]));
...
const originalText = new WeakMap();
  ...
  const initialLanguage = savedLanguage || (["en","de","fr","es"].includes(browserLanguage) ? browserLanguage : "en");
